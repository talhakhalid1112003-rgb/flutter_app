...
final matchesBySportProvider = StreamProvider.family<List<AppMatch>, String>((
  ref,
  sportId,
) {
  return ref.watch(matchRepositoryProvider).watchMatches(sportId);
});

final inningsProvider = StreamProvider.family<List<AppInnings>, String>((
  ref,
  matchId,
) {
...
final ballsProvider = StreamProvider.family<List<AppBall>, Map<String, String>>(
  (ref, params) {
    return ref
        .watch(matchRepositoryProvider)
        .watchBalls(params['matchId']!, params['inningsId']!);
  },
);

final playerStatsProvider = StreamProvider.family<List<PlayerStats>, String>((
  ref,
  matchId,
) {
