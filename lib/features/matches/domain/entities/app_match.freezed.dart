...
mixin _$AppMatch {
 ...
 String get matchId; String get teamAName; String get teamBName; String? get teamAId; String? get teamBId; int get overs; String get tossWinner; String get tossDecision;// 'bat' or 'bowl'
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,matchId,teamAName,teamBName,teamAId,teamBId,overs,tossWinner,tossDecision,matchStatus,currentPhase,targetScore,matchResult,currentStrikerId,currentNonStrikerId,currentBowlerId,createdAt);

@override
String toString() {
  return 'AppMatch(matchId: $matchId, teamAName: $teamAName, teamBName: $teamBName, teamAId: $teamAId, teamBId: $teamBId, overs: $overs, tossWinner: $tossWinner, tossDecision: $tossDecision, matchStatus: $matchStatus, currentPhase: $currentPhase, targetScore: $targetScore, matchResult: $matchResult, currentStrikerId: $currentStrikerId, currentNonStrikerId: $currentNonStrikerId, currentBowlerId: $currentBowlerId, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String matchId, String teamAName, String teamBName, String? teamAId, String? teamBId, int overs, String tossWinner, String tossDecision, String matchStatus, MatchPhase currentPhase, int? targetScore, String? matchResult, String? currentStrikerId, String? currentNonStrikerId, String? currentBowlerId, DateTime createdAt
});
...
/// Create a copy of AppMatch
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? matchId = null,Object? teamAName = null,Object? teamBName = null,Object? teamAId = freezed,Object? teamBId = freezed,Object? overs = null,Object? tossWinner = null,Object? tossDecision = null,Object? matchStatus = null,Object? currentPhase = null,Object? targetScore = freezed,Object? matchResult = freezed,Object? currentStrikerId = freezed,Object? currentNonStrikerId = freezed,Object? currentBowlerId = freezed,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String matchId,  String teamAName,  String teamBName,  String? teamAId,  String? teamBId,  int overs,  String tossWinner,  String tossDecision,  String matchStatus,  MatchPhase currentPhase,  int? targetScore,  String? matchResult,  String? currentStrikerId,  String? currentNonStrikerId,  String? currentBowlerId,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppMatch() when $default != null:
return $default(_that.matchId,_that.teamAName,_that.teamBName,_that.teamAId,_that.teamBId,_that.overs,_that.tossWinner,_that.tossDecision,_that.matchStatus,_that.currentPhase,_that.targetScore,_that.matchResult,_that.currentStrikerId,_that.currentNonStrikerId,_that.currentBowlerId,_that.createdAt);case _:
  return orElse();
